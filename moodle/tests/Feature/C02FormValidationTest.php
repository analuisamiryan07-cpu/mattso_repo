...
class C02FormValidationTest extends TestCase
{
    ...
    public function test_document_generation_rejects_invalid_identity_formats(): void
    {
        foreach (['171234567', '1712345678002', '17123A5678'] as $invalidIdentity) {
            $payload = $this->validPayload();
            $payload['cedula'] = $invalidIdentity;
