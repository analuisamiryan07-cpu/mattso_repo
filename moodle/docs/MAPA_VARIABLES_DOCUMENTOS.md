...
La empresa se registra como metadato del proceso, no como marcador documental.
El valor permitido es `SAPPER`, `MATSSO` o `FUMALU`; hasta que se mapeen sus
plantillas, solo `SAPPER` puede generar documentos desde el formulario actual.
