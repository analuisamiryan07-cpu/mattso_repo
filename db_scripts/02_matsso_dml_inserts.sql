...
-- 1. VIGENCIAS
-- =============================================================================
INSERT INTO matsso.vigencia (anos, etiqueta) VALUES (2, '2 años');
INSERT INTO matsso.vigencia (anos, etiqueta) VALUES (3, '3 años');
INSERT INTO matsso.vigencia (anos, etiqueta) VALUES (4, '4 años');
INSERT INTO matsso.vigencia (anos, etiqueta) VALUES (5, '5 años');

-- =============================================================================
-- 2. FAMILIAS
-- =============================================================================
INSERT INTO matsso.familia (nombre) VALUES ('Actividades Tipo Servicios');
INSERT INTO matsso.familia (nombre) VALUES ('Actividades de Enseñanza');
INSERT INTO matsso.familia (nombre) VALUES ('Actividades de Salud');
INSERT INTO matsso.familia (nombre) VALUES ('Comercialización y Venta de productos');
INSERT INTO matsso.familia (nombre) VALUES ('Construcción');
INSERT INTO matsso.familia (nombre) VALUES ('Electricidad Gas y Agua');
INSERT INTO matsso.familia (nombre) VALUES ('Electricidad gas y agua');
INSERT INTO matsso.familia (nombre) VALUES ('Metalmecánica');
INSERT INTO matsso.familia (nombre) VALUES ('Servicios Financieros');
INSERT INTO matsso.familia (nombre) VALUES ('Tecnología: Hardware y Software (Incluye TICS)');
INSERT INTO matsso.familia (nombre) VALUES ('Transformación de Alimentos');
INSERT INTO matsso.familia (nombre) VALUES ('Transporte Almacenamiento y Logística');

-- =============================================================================
-- 3. SECTORES
-- =============================================================================
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Electricidad Gas y Agua'), 'Suministro de Electricidad');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades Administrativas y de Apoyo de Oficina y Otras Actividades de Apoyo');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Metalmecánica'), 'Fabricación de Productos Elaborados de Metal Excepto Maquinaria de Equipo');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Otras Actividades de Servicios Profesionales');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Construcción'), 'Actividades Especializadas de la Construcción');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Servicios Financieros'), 'Actividades Jurídicas de Contabilidad');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades de Asistencia Social sin Alojamiento');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades de Bibliotecas Archivos Museos y Otras');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales Científicas y Técnicas');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Transporte Almacenamiento y Logística'), 'Transporte por Vía Terrestre y por Tuberías');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades de Atención de la Salud Humana');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales, Científicas y Técnicas');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Administración Pública y Defensa');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades de Enseñanza'), 'Enseñanza');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades Administrativas y de Apoyo de Oficina');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades de Oficinas Principales');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Metalmecánica'), 'Fabricación de Productos Elaborados de Metal');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Comercialización y Venta de productos'), 'Publicidad y Estudio de Mercado');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Servicios Financieros'), 'Actividades Auxiliares de las Actividades de Servicios');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Electricidad gas y agua'), 'Suministro de Electricidad, Gas, Vapor y Aire Acondicionado');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Actividades de Descontaminación');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Electricidad Gas y Agua'), 'Suministro de Electricidad Gas Vapor y Aire Acondicionado');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Transformación de Alimentos'), 'Elaboración de Productos Alimenticios');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales Técnicas');
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre = 'Actividades Tipo Servicios'), 'Administración Pública y Defensa; Planes de Seguridad');
