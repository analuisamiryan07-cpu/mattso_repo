...
-- 3. SECTORES
-- =============================================================================
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Electricidad Gas y Agua'), 'Suministro de Electricidad') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades Administrativas y de Apoyo de Oficina y Otras Actividades de Apoyo') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Metalmecánica'), 'Fabricación de Productos Elaborados de Metal Excepto Maquinaria de Equipo') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Otras Actividades de Servicios Profesionales') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Construcción'), 'Actividades Especializadas de la Construcción') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Servicios Financieros'), 'Actividades Jurídicas de Contabilidad') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades de Asistencia Social sin Alojamiento') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades de Bibliotecas Archivos Museos y Otras') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales, Científicas y Técnicas') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Transporte Almacenamiento y Logística'), 'Transporte por Vía Terrestre y por Tuberías') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades de Atención de la Salud Humana') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales, Científicas y Técnicas') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Administración Pública y Defensa') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades de Enseñanza'), 'Enseñanza') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades Administrativas y de Apoyo de Oficina') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades de Oficinas Principales') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Metalmecánica'), 'Fabricación de Productos Elaborados de Metal') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Comercialización y Venta de productos'), 'Publicidad y Estudio de Mercado') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Servicios Financieros'), 'Actividades Auxiliares de las Actividades de Servicios') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Electricidad gas y agua'), 'Suministro de Electricidad, Gas, Vapor y Aire Acondicionado') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Actividades de Descontaminación') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Electricidad Gas y Agua'), 'Suministro de Electricidad Gas Vapor y Aire Acondicionado') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Transformación de Alimentos'), 'Elaboración de Productos Alimenticios') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Otras Actividades Profesionales Técnicas') ON CONFLICT (nombre) DO NOTHING;
INSERT INTO matsso.sector (id_familia, nombre) VALUES ((SELECT id_familia FROM matsso.familia WHERE nombre ILIKE 'Actividades Tipo Servicios'), 'Administración Pública y Defensa; Planes de Seguridad') ON CONFLICT (nombre) DO NOTHING;
