...
const CertificationDetail = () => {
  ...
  return (
    <div className="certification-detail-page">
      ...
      <section
        className="cert-hero"
        style={cert.cloudinaryNum
          ? { backgroundImage: `url('${cloudinaryUrl(`${cert.cloudinaryNum}_hero`, { width: 1920, height: 700 })}')` }
          : undefined}
      >
